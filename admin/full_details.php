        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
					...
					<center><h4 class="modal-title" id="myModalLabel">Chi tiết mua hàng</h4></center>
                </div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							<span>Khách hàng: <strong><?php echo ucwords($srow['customer_name']); ?></strong></span>
							<span class="pull-right">Ngày: <strong><?php echo date("d/m/Y", strtotime($srow['sales_date'])); ?></strong></span>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<table width="100%" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									?>
									<tr>
										<td align="right" colspan="3"><strong>Tổng cộng</strong></td>
