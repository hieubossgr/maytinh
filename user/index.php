			...
			?>
				...
				<div>
					...
					<div style="margin-left:17px; margin-right:17px;">
						<button type="button" class="btn btn-primary btn-sm addcart" value="<?php echo $row['productid']; ?>"><i class="fa fa-shopping-cart fa-fw"></i> Thêm vào giỏ</button> <span class="pull-right"><strong><?php echo number_format($row['product_price'],3); ?></strong></span> 
					</div>
				</div>
				</div>
			<?php
