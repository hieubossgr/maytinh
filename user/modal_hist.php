        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
					...
					<center><h3 class="modal-title" id="myModalLabel">Chi tiết mua hàng đầy đủ</h3></center>
                </div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							<p class="pull-right">Ngày: <?php echo date("d/m/Y", strtotime($srow['sales_date'])); ?></p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<table width="100%" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									?>
									<tr>
										<td align="right" colspan="3"><strong>Thành tiền</strong></td>
